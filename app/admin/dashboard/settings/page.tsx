            ...
            <form action="" className="flex flex-col gap-5">
                <div className="flex flex-col lg:flex-row gap-5">
                    <div className="flex gap-2 w-full">
                        ...
                        <input type="text" placeholder="Facebook URL" className="w-full mt-2 text-[16px] text-[#595959] placeholder:text-[#9E9E9E] border border-[#E0E0E0] rounded-[8px] px-[14px] py-4" />
                    </div>
                    <div className="flex gap-2 w-full">
                        <Image src={twitterLogo} alt="twitter-logo" />
                        <input type="text" placeholder="Twitter URL" className="w-full mt-2 text-[16px] text-[#595959] placeholder:text-[#9E9E9E] border border-[#E0E0E0] rounded-[8px] px-[14px] py-4" />
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-5">
                    <div className="flex gap-2 w-full">
                        ...
                        <input type="text" placeholder="LinkedIn URL" className="w-full mt-2 text-[16px] text-[#595959] placeholder:text-[#9E9E9E] border border-[#E0E0E0] rounded-[8px] px-[14px] py-4" />
                    </div>
                    <div className="flex gap-2 w-full">
                        <Image src={instagramLogo} alt="instagram-logo" />
                        <input type="text" placeholder="Instagram URL" className="w-full mt-2 text-[16px] text-[#595959] placeholder:text-[#9E9E9E] border border-[#E0E0E0] rounded-[8px] px-[14px] py-4" />
                    </div>
                </div>
