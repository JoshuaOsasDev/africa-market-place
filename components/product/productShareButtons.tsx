...
export function ProductShareButtons({
  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      <span className="text-[#6F6F6F] text-sm font-medium">Share item:</span>
        ...
        {socialButtons.map((button) => {
          ...
          return (
            <button
              ...
              className={cn(
                "w-9 h-9 rounded-full bg-[#2E7D32] text-white flex items-center justify-center transition-all duration-300",
                button.color
              )}
