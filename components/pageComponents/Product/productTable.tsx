...
import ProductRender from "../vendor/Product/productRender";
...
export default function ProductTable({
  ...
  const newData = paginatedProducts.map((data) => {
    return {
      product: data,
    };
  });
      ...
      <Table columns="2px 2.5fr 0.85fr 1fr 1.1fr 1.1fr 1.3fr 1.3fr 1.1fr">
        ...
        <Table.Body
          ...
          render={(product: { product: Product }) => (
            <ProductRender key={product.product.id} product={product.product} />
          )}
        />
