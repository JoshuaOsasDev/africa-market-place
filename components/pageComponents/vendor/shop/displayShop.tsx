...
import CreateShop from "../order/createShop";
        ...
        {show && type === "Shop" ? (
          ...
          <div>
            <ProductHeading
              ...
              id=""
            />
            <div className="mt-2 mb-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              <div className="space-y-6 lg:col-span-2">
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <div className="flex-row justify-between space-y-3 pr-5 md:flex">
                    <div>
                    ...
                    <div>
                      ...
                      {shop.identityVerification?.proofOfAddress?.url ? (
                        <div className="group relative overflow-hidden rounded-lg border border-gray-200">
                          ...
                          />
                          <div className="bg-opacity-0 group-hover:bg-opacity-40 absolute inset-0 flex items-center justify-center bg-black/20 transition">
              ...
              <div className="flex flex-col space-y-2">
                <Link href={"/vendor/dashboard/product"} className="">
                ...
                <Link href={"/vendor/dashboard/orders"} className="">
                  <button className="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50">
                    View Orders
                  </button>
                </Link>

                <Link href={"/vendor/dashboard/setting"} className="">
                  <button className="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50">
                    Manage Settings
                  </button>
                </Link>
