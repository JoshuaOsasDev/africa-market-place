...
interface ProductDetailClientProps {
  // Safe dynamic route parameters
  resolvedParams: { slug: string } | null | undefined;
}
...
export default function ProductDetailClient({
  ...
  /**
   * Safely retrieve slug, defaulting to an empty string if resolvedParams is missing
   */
  ...
  const { userProductsSlug, isLoading } = useUserProductsBySlug(slug);
  ...
  //console.log(product, "slug in client component");
  /**
  ...
  const handleToggleWishlist = () => {
    ...
    console.log(product, "toggling wishlist");
